...
class TestReview(unittest.TestCase):
    ...
    def test_Review_inheritance(self):
        """
            tests if the Review class Inherits from BaseModel
        """
        new_review = Review()
    ...
    def test_Review_attributes(self):
        """
            Tests if Review class has place_id, user_id and text
            attributes.
        """
        new_review = Review()
    ...
    def test_Review_attributes(self):
        """
            Test if Review class has place_id, user_id and text
            attributes.
        """
        new_review = Review()
