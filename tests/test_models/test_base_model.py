...
"""
    All tests for the base_model are done here.
"""
...
class TestBase(unittest.TestCase):
    ...
    def test_id_type(self):
        """
            Checks if type of the id is string.
        """
        self.assertEqual("<class 'str'>", str(type(self.my_model.id)))

    def test_ids_differ(self):
        """
            Checks if the ids btn two instances are different.
        """
        new_model = BaseModel()
    ...
    def test_save(self):
        """
            Checks that after updating the instance; the dates differ both
        """
    ...
    def test_str_overide(self):
        """
            Checks if the right message gets printed.
        """
        backup = sys.stdout
    ...
    def test_to_dict_type(self):
        """
            Checks the to_dict method return type.
        """
    ...
    def test_to_dict_type_updated_at(self):
        """
            Checks type of the value of updated_at.
        """
    ...
    def test_kwargs_instantiation(self):
        """
            Tests if an instance is created using the
            key value pair.
        """
    ...
    def test_type_created_at(self):
        """
            Tests if the new_model's updated_at
            data type is a datetime.
        """
        my_model_dict = self.my_model.to_dict()
        new_model = BaseModel(my_model_dict)
    ...
    def test_type_updated_at(self):
        """
            Tests if the new_model's created_at
            data type is a datetime.
        """
        my_model_dict = self.my_model.to_dict()
        new_model = BaseModel(my_model_dict)
